...
The method outputs "Previous balance: _$_" + balance.
The method adds amount to balance.
The method outputs "Current balance: $" + balance.
The method calls method saveTransaction with variables "Deposit" and amount.
